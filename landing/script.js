...
// ===== Console Easter Egg =====
console.log('%c👋 ¡Hola! ¿Interesado en cómo hicimos esto?', 'font-size: 16px; font-weight: bold;');
console.log('%cMiCita - Hecho con ❤️ en Venezuela 🇻🇪', 'font-size: 14px; color: #14b8a6;');
