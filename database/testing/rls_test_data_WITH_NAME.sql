-- 🧪 RLS Testing Data Script (WITH NAME COLUMN)
-- Fixed to include the missing 'name' column for providers
...
-- Create provider business profiles (FIXED - including name column)
...
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'::uuid, 1, '09:00', '17:00', true), -- Monday
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'::uuid, 2, '09:00', '17:00', true), -- Tuesday  
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'::uuid, 3, '09:00', '17:00', true), -- Wednesday
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'::uuid, 4, '09:00', '17:00', true), -- Thursday
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'::uuid, 5, '09:00', '17:00', true), -- Friday
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'::uuid, 6, '09:00', '15:00', true), -- Saturday
-- Luis's Schedule (Tuesday to Sunday)
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb'::uuid, 2, '10:00', '19:00', true), -- Tuesday
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb'::uuid, 3, '10:00', '19:00', true), -- Wednesday
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb'::uuid, 4, '10:00', '19:00', true), -- Thursday  
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb'::uuid, 5, '10:00', '19:00', true), -- Friday
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb'::uuid, 6, '10:00', '19:00', true), -- Saturday
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb'::uuid, 0, '11:00', '17:00', true); -- Sunday
...
UNION ALL  
SELECT 'Providers Created:', COUNT(*) FROM public.providers WHERE business_name LIKE '%Ana%' OR business_name LIKE '%Luis%'
UNION ALL
